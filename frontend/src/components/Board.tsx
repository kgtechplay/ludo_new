...
// Main path 0-55: [row, col] on 15x15 grid. Single connected loop around center.
...
const SAFE_PATH_INDEXES = new Set([1, 14, 29, 43]);
    ...
    <section className="w-full max-w-[900px]">
      ...
      >
        ...
        {[
          ...
          { color: "yellow" as const, row: 0, col: 10 },
          { color: "red" as const, row: 10, col: 0 },
          { color: "blue" as const, row: 10, col: 10 },
        ].map((home) => (
          <div
            key={`${home.color}-home`}
